		...
		<div id="show-producentBestallning" class="content scaffold-show" role="main">
			...
			<g:form url="[resource:producentBestallningInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link controller="registreraTjansteKontrakt" class="edit" action="edit" resource="${producentBestallningInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
